...
export const providerProfileSystemInstructions = [
  ...
  "Every emitted fact must carry its own citation object. sourceUrl is the exact consulted public page supporting that fact. providerIdentitySpan establishes the requested provider on that page, factSpan establishes the exact emitted fact on the same page, and explicitFactDateSpan is an explicit date governing that fact or null.",
