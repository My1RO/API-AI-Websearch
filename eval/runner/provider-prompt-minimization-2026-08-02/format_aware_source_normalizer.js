...
const DEPENDENCY_MODULES = process.env.PROVIDER_EVAL_NODE_MODULES
  || path.resolve(__dirname, "../../../API-AI-Websearch/node_modules");
...
const WORKBOOK_TIMEOUT_BASIS = Object.freeze({
  ...
  fixtures: ["H037 Ohio Medicaid XLSX", "H038 EPA XLSX", "H057 Education XLS"],
  worstMeasuredParseMs: 6_600,
  policy: "subprocess_at_least_18x_and_worker_at_least_22x_measured_worst_case"
});
