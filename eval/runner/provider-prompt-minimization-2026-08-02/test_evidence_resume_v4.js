...
process.env.PROVIDER_EVAL_NODE_MODULES ||= path.join(process.env.EDE_SHARED_WORKSPACE || "/Users/kui/lucie/EDE",
  "test-evidence/provider-successor-experiment-2026-07-30/node_modules");
const collector = require("../provider-d-series-2026-07-31/generated/collect_d_evidence_v7.js");
const formatNormalizer = require("./format_aware_source_normalizer.js");
const evidenceResume = require("./resume_format_aware_evidence_v4.js");
const { evaluatorRunnerAuthority } = require("./evaluator_runner_authority.js");
const { verifyProductionBinding } = require("./run_evaluator_campaign.js");
...
const baseResult = (source) => ({ ...source, finalUrl: source.requestedUrl, redirects: [], httpStatus: 200,
  ...
  startedAt: "2026-08-01T00:00:00.000Z", completedAt: "2026-08-01T00:00:00.001Z",
...
(async () => {
  ...
  try {
    ...
    const fetchError = { ...byUrl.get(urls[2]), finalUrl: null, redirects: [], httpStatus: null,
      tlsVerification: "not_completed", durationMs: 30, startedAt: "2026-08-01T00:00:00.000Z",
      completedAt: "2026-08-01T00:00:00.030Z", bytesObserved: 0, bytesRetained: 0,
