...
const normalizer = require("../core/format_aware_source_normalizer.js");
...
if (process.env.WORKBOOK_PYTHON) {
  ...
  try {
    ...
    assert.equal(workbook.timeoutPolicy.basis.policy,
      "bounded_subprocess_and_worker_timeouts_for_large_workbook_normalization");
