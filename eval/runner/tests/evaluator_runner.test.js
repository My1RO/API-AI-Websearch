...
const { STAGES, assertManifestRuntimeAuthority, collectManualTriggerFiles,
  expectedArtifactAuthorityForStage } = require("../core/run_evaluator_campaign.js");
...
try {
  ...
  childProcess.execFileSync(process.execPath,
    [path.join(__dirname, "../core/run_evaluator_campaign.js"), manifestFile, "verify-packets"], { stdio: "pipe" });
  ...
  const denied = childProcess.spawnSync(process.execPath,
    [path.join(__dirname, "../core/verify_campaign.js")], { encoding: "utf8" });
