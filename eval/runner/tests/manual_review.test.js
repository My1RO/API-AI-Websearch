...
const harness = require("../core/manual_review_harness.js");
const correctedSchema = require("../core/synthesis_judge_schema.js");
...
try {
  ...
  const writeReview = (unit, { reviewerId = "same-reviewer", tracePath = "raw-review-trace.json" } = {}) => {
    ...
    fs.writeFileSync(path.join(unitRoot, "review-output.json"), JSON.stringify({
      ...
      startedAt: "2000-01-01T00:00:00Z", completedAt: "2000-01-01T00:00:01Z", durationMs: 1000,
