...
describe("provider profile production contract", () => {
  let consoleLogSpy;
  ...
  it("retains a direct citation absent from every native provenance channel", () => {
    const raw = response({
      type: "web_search_call",
  ...
  it("preserves directly supported address and phone facts", () => {
